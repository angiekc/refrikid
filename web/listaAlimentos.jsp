                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title">Lista Alimentos</h3>
                        </div>
                        <div class="row">
                            <%   
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                ...
                                                <%  ProductoVO bebidas=new ProductoVO();
                                                    ProductoDAO prodaocuatro=new ProductoDAO(bebidas);
                                                    ArrayList<ProductoVO>listaocho=prodaocuatro.listarbebidas();
                                                    for (int i = 0; i < listaocho.size(); i++) {
                                                        bebidas=listaocho.get(i);
                                                %>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td><%= bebidas.getIdproducto() %></td>
                                                    <td><%= bebidas.getNombreProducto() %></td>
                                                    <td><%= bebidas.getCalorias() %></td>
                                                    <td><%= bebidas.getHidratos()%></td>
                                                    <td><%= bebidas.getGrasas() %></td>
                                                    <td><%= bebidas.getProteinas() %></td>
                                                </tr>
                                                <% }%>
                                            </tbody>
                                        </table>
