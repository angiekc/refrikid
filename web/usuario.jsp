                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Padre de familia recuerde registrar o actualizar los datos de Peso y Estatura debe ir a la opción <b>Datos de Crecimiento</b> de menú principal. 
                            <br>Si ya lo realizo hacer caso omiso de este informe.</p>
                    
                            <h4 class="card-title">Desea actualizar la información de su hij@, si es así debe dar click en el botón <b>ACTUALIZAR</b></h4>
                            <a href="historial.jsp"><button type="button" class="btn btn-gradient-success btn-sm">Actualizar</button></a>
                        </div>
                    </div>
                </div>
            </div>
