...
<html lang="en">
    ...
    <body>
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title">Registrar Datos de Crecimiento</h3>
                        </div>
                        <div class="row">
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-sample" method="post" action="Historial" id="formSubmit">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Fecha de Registro (Fecha Actual)</label>
                                                        <div class="col-sm-9">
                                                            <input type="date" class="form-control" name="fechaNacimiento" id="fecha">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="peso" placeholder="Peso" id="peso">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="talla" placeholder="Estatura" id="estatura">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="reset" class="btn btn-gradient-light btn-rounded btn-fw">Restablecer</button>
                                            <button class="btn btn-gradient-success btn-rounded btn-fw" id="btnenviar" onclick="validate()">Ingresar</button>
        ...
        <script src="js/logicaHistorial.js" type="text/javascript"></script>
    </body>
</html>
