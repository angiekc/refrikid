                    ...
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h4 class="card-title">Agregar Producto</h4>
                                        <form class="form-sample" action="Producto" method="post" id="formView">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Calorias</label>
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="calorias" id="calorias">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Hidratos</label>
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="hidratos" id="hidratos">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Grasas</label>
                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="grasas" id="grasas">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Proteinas</label>
                                                        <div class="col-sm-9">
