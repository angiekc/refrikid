                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="img/logotipoFinal.png">
                                        <p>Desea ingresar un nuevo producto</p>
                                        <a href="registrarProducto.jsp"><button class="btn btn-gradient-success btn-rounded btn-fw" id="btnenviar">Ingresar Nuevo Producto</button></a>
