...
<html lang="en">
    ...
    <body>
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title">Creación del menú</h3>
                        </div>
                        <div class="row">
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-sample" action="Menu" method="post" id="formView">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="vegetal" id="vegetal" class="form-control">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="legumbre"  id="legumbre" class="form-control">
                                                                <option>-- SELECCIONE --</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="carne" id="carne" class="form-control">
                                                                <option>-- SELECCIONE --</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="lacteo" id="lacteo" class="form-control">
                                                                <option>-- SELECCIONE --</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="pescado" id="pescado" class="form-control">
                                                                <option>-- SELECCIONE --</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="embutido" id="embutido" class="form-control">
                                                                <option>-- SELECCIONE --</option>
                                            ...
                                            <div class="row">              
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Bebidas</label>
                                                        <div class="col-sm-9">
                                                            <select name="bebidas" id="bebida" class="form-control">
                                                                <option>-- SELECCIONE --</option>
                                                                <% ProductoVO procuatro=new ProductoVO();
                                                                    ProductoDAO prodaocuatro=new ProductoDAO(procuatro);
                                                                    ArrayList<ProductoVO>listaocho=prodaocuatro.listarbebidas();
                                                                    for (int i = 0; i < listaocho.size(); i++) {
                                                                       procuatro=listaocho.get(i);
                                                                %>
                                                                <option><%= procuatro.getNombreProducto() %></option>
                                                                <% }%>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <input type="submit" class="btn btn-gradient-success btn-rounded btn-fw" id="btnvisualizar" onclick="validate()" value="Seleccionar menú"/>
                        ...
                        <div class="row">
                            <div class="main-panel">
                                <div class="col-lg-9 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="form-sample" action="Menu" method="post" id="formSubmit">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        <td><label> BEBIDAS </label></td>
                                                        <td><input id="menu" type="text" name="bebidastext" value="<%=request.getParameter("bebidas")%>" />  </td>
                                                      </tr>
                                                    </tbody>
                                                </table>
        ...
        <script src="js/logicaMenu.js" type="text/javascript"></script>
    </body>
</html>
